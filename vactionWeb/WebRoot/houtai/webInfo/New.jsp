  ...
  <head>
    ...
    <body>
        ...
        <form class="layui-form x-center" action="" style="width:500px">
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="new_add('添加用户','<%=path %>/houtai/webInfo/new_add.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:25px">共有数据：88 条</span></xblock>
            <table class="layui-table">
                ...
                <tbody id="x-img">
                    <tr>
                        ...
                        <td>新闻标题</td>
                        <td align="left">
                            <img src="<%=path %>/houtai/images/img1.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容新闻内容</td>
                        <td class="td-status">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="修改" href="javascript:;" onclick="new_edit('修改','<%=path %>/houtai/webInfo/new_edit.jsp','4','','510')"
                     ...
                     <tr>
                        ...
                        <td >2017-07-15</td>
                        <td >几乎是一夜之间，一场食盐抢购风席卷了全国各地，如同地震引发的海啸一般，这场突如其来的抢购让很多人猝不及防。
 抢购现象最早从浙江和广东等地开始。</td>
                        <td class="td-status">
                            <span class="layui-btn layui-btn-normal layui-btn-mini">
                                已显示
