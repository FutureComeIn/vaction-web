  ...
  <head>
    ...
    <body>
        ...
        <form class="layui-form x-center" action="" style="width:500px">
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="home_add('添加用户','<%=path %>/houtai/webInfo/home_add.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:25px">共有数据：88 条</span></xblock>
            <table class="layui-table">
                ...
                <tbody id="x-img">
                    <tr>
                        ...
                        <td>pic1</td>
                        <td align="left">
                            <img src="<%=path %>/houtai/images/banner1.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-19</td>
                        <td >简述...</td>
                        <td class="td-status">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="修改" href="javascript:;" onclick="home_edit('修改','<%=path %>/houtai/webInfo/home_edit.jsp','4','','510')"
                     ...
                     <tr>
                        ...
                        <td>pic2</td>
                        <td align="left">
                            <img src="<%=path %>/houtai/images/banner3.png" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-19</td>
                        <td >简述...</td>
                        <td class="td-status">
                     ...
                     <tr>
                        ...
                        <td>product1</td>
                        <td align="left">
                            <img src="<%=path %>/houtai/images/c1.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >专用个人沙盘游戏设备（箱庭疗法）老师：181542342492老师：1875435345493</td>
                        <td class="td-status">
                            <span class="layui-btn layui-btn-normal layui-btn-mini">
                                已显示
                            </span>
                    ...
                    <tr>
                        ...
                        <td>product2</td>
                        <td align="left">
                            <img src="<%=path %>/houtai/images/c2.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                    ...
                    <tr>
                        ...
                        <td>teacher1</td>
                        <td align="left">
                            <img src="<%=path %>/houtai/images/t1.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >老师1</td>
                        <td class="td-status">
                    ...
                    <tr>
                        ...
                        <td>teacher2</td>
                        <td align="left">
                            <img src="<%=path %>/houtai/images/t2.jpg" alt="" width="56" height="56">
                        </td>
                        <td >2017-07-15</td>
                        <td >老师2</td>
                        <td class="td-status">
