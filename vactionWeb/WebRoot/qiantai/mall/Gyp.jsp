        ...
        <div class="search_nav fl">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li><a href="<%=path %>/qiantai/scenic/scenic_list.jsp">孟津旅游</a></li>
                    <li><a class="cur" href="<%=path %>/qiantai/mall/mall_list.jsp">特产商城</a></li>
                    <li><a href="<%=path %>/qiantai/note/note_list.jsp">攻略游记</a></li>
		...
		<div class="w810 fl">
			...
			<div class="public_box bg1">
				...
				<div id="list_sort">
					<span>产品类型：</span>
					<div class="list_1">
						<a href="#" id="all" onclick="Typechange('all')">全部</a>
						<a href="#" id="Ncp" onclick="Typechange('Ncp')">农产品</a>
						<a href="#" id="Sg" onclick="Typechange('Sg')">水果</a>
						<a href="#" id="Gyp" onclick="Typechange('Gyp')" class="cur">工艺品</a>
				...
				<!------------------特产列表-------------------->
				<div id="mall_list">
					<c:forEach items="${GypList}" var="Gyp">
					<ul>
						<li>
							<div class="pic"><a href="<%=path %>/StepServlet?gno=${Gyp.gno}"><img class="scale-effect" src="${Gyp.gheadphotopath}"/></a></div>
							<div class="con">
								<h3><a href="<%=path %>/StepServlet?gno=${Gyp.gno}">${Gyp.gname}</a></h3>
								<label>${Gyp.gplace}</label>
							</div>
							<div class="price">
								<p>￥<label>${Gyp.gprice}</label></p>
								<span>运费: 5.00</span>
							</div>
							<div class="other">
								<span>${Gyp.gdealcount}人付款</span>
								<a href="<%=path %>/StepServlet?gno=${Gyp.gno}">132条评论</a>
							</div>
							<div class="view">
								<a href="<%=path %>/StepServlet?gno=${Gyp.gno}">查看详情</a>
							</div>
							<div class="clear"></div>
						</li>
