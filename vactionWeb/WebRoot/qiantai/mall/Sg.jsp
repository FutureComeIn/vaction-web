			...
			<div class="public_box bg1">
				...
				<div id="list_sort">
					...
					<div class="list_1">
						...
						<a href="#" id="Sg" onclick="Typechange('Sg')" class="cur">水果</a>
				...
				<div id="mall_list">
					...
					<ul>
						<li>
							<div class="pic"><a href="<%=path %>/StepServlet?gno=${Sg.gno}"><img class="scale-effect" src="${Sg.gheadphotopath}"/></a></div>
							<div class="con">
								<h3><a href="<%=path %>/StepServlet?gno=${Sg.gno}">${Sg.gname}</a></h3>
								<label>${Sg.gplace}</label>
							</div>
							<div class="price">
								<p>￥<label>${Sg.gprice}</label></p>
								<span>运费: 5.00</span>
							</div>
							<div class="other">
								<span>${Sg.gdealcount}人付款</span>
								<a href="<%=path %>/StepServlet?gno=${Sg.gno}">132条评论</a>
							</div>
							<div class="view">
								<a href="<%=path %>/StepServlet?gno=${Sg.gno}">查看详情</a>
							</div>
							<div class="clear"></div>
						</li>
