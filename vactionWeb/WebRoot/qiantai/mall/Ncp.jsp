			...
			<div class="public_box bg1">
				...
				<div id="list_sort">
					...
					<div class="list_1">
						...
						<a href="#" id="Ncp" onclick="Typechange('Ncp')" class="cur">农产品</a>
				...
				<!------------------特产列表-------------------->
				<div id="mall_list">
					<c:forEach items="${NcpList}" var="Ncp">
					<ul>
						<li>
							<div class="pic"><a href="<%=path %>/StepServlet?gno=${Ncp.gno}"><img class="scale-effect" src="${Ncp.gheadphotopath}"/></a></div>
							<div class="con">
								<h3><a href="<%=path %>/StepServlet?gno=${Ncp.gno}">${Ncp.gname}</a></h3>
								<label>${Ncp.gplace}</label>
							</div>
							<div class="price">
								<p>￥<label>${Ncp.gprice}</label></p>
								<span>运费: 5.00</span>
							</div>
							<div class="other">
								<span>${Ncp.gdealcount}人付款</span>
								<a href="<%=path %>/StepServlet?gno=${Ncp.gno}">132条评论</a>
							</div>
							<div class="view">
								<a href="<%=path %>/StepServlet?gno=${Ncp.gno}">查看详情</a>
							</div>
							<div class="clear"></div>
						</li>
