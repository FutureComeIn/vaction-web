			...
			<div class="public_box bg1">
				...
				<div id="list_sort">
					...
					<div class="list_1">
						...
						<a href="#" id="Fsp" onclick="Typechange('Fsp')" class="cur">副食品</a>
						<div class="clear"></div>
					</div>
                </div>
				<!------------------特产列表-------------------->
				<div id="mall_list">
				<c:forEach items="${FspList}" var="Fsp">
					<ul>
						<li>
							<div class="pic"><a href="<%=path %>/StepServlet?gno=${Fsp.gno}"><img class="scale-effect" src="${Fsp.gheadphotopath}"/></a></div>
							<div class="con">
								<h3><a href="<%=path %>/StepServlet?gno=${Fsp.gno}">${Fsp.gname}</a></h3>
								<label>${Fsp.gplace}</label>
							</div>
							<div class="price">
								<p>￥<label>${Fsp.gprice}</label></p>
								<span>运费: 5.00</span>
							</div>
							<div class="other">
								<span>${Fsp.gdealcount}人付款</span>
								<a href="<%=path %>/StepServlet?gno=${Fsp.gno}">132条评论</a>
							</div>
							<div class="view">
								<a href="<%=path %>/StepServlet?gno=${Fsp.gno}">查看详情</a>
							</div>
							<div class="clear"></div>
						</li>
