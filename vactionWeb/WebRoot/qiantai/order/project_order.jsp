...
%>
<%
	String sql="select *from(select *from tv_goodorder g inner join tv_orderdetail o on g.gono=o.odgono) go inner join tv_goods gd on go.odgno=gd.gno";
	...
	<div class="public_box pd10">
		...
		<div class="public_tag">
			<ul>
				...
				<li><a href="<%=path %>/qiantai/order/Daifuk.jsp">待付款</a></li>
				<div class="clear"></div>
			</ul>
		</div>
		<!-----------------商品订单---------------->
