...
<head>
    ...
    <script type="text/javascript">
    	function skippage(currentPage){
    		window.location.href="<%=path %>/ScenicServlet?type=qt_select&currentPage="+currentPage;
    	}
    </script>  
</head>
<body>
        ...
        <div class="search_nav fl">
            ...
            <div class="nav">
                <ul>
	                ...
	                <li><a class="cur" title="" href="<%=path %>/ScenicServlet?type=qt_select">孟津旅游</a></li>
    ...
    <div class="cw1200">
		<div class="w810 fl">
			...
			<div class="public_box bg1">
				...
				<div id="list_sort">
					<ul>
						<li><span>产品类型：</span><a class="cur" href="<%=path %>/qiantai/scenic/scenic_list.jsp">旅游景区</a><div class="clear"></div></li>
					</ul>
				</div>
				<!------------------景区列表-------------------->
				<div id="scenic_list">
					<ul>
						...
						<li>
							<div class="pic"><a href="<%=path %>/ScenicServlet?type=qt_select1&sno=${scenic.sno}"><img class="scale-effect" src="${scenic.sheadpath }"/></a></div>
							<div class="con">
								<h3><a href="<%=path %>/ScenicServlet?type=qt_select1&sno=${scenic.sno}">${scenic.sname }</a></h3>
								<p>简介</p>
							</div>
							<div class="tip">
								<img src="<%=path %>/images/scenic_ico.png"/>景区
							</div>
							<div class="clear"></div>
						</li>
						</c:forEach>
					</ul>
					<button onclick="skippage(1)">首页</button>&nbsp;&nbsp;
					<button onclick="skippage('${currentPage>1?currentPage-1:1}')">上一页</button>&nbsp;&nbsp;
					<button onclick="skippage('${currentPage<sdata.pageNum?currentPage+1:sdata.pageNum}')">下一页</button>&nbsp;&nbsp;
                    <button onclick="skippage('${sdata.pageNum }')">末页</button>	
				</div>
			...
			<div class="public_box bg2">
				...
				<div id="public_recom">
					<ul>
						...
						<li>
							<a href="#">
								<div class="pic"><img class="scale-effect" src="<%=path %>/images/t2.jpg"/></div>
								<p>洛阳古城慢时</p>
							</a>
						</li>
						<div class="clear"></div>
